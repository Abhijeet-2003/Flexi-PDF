...
const ToPPT = () => {
    ...
    const handlePPT = async () => {
        if(selectedFile){
            ...
            console.log('pptx');
            try{
            await axios.post("http://localhost:8000/api/convert/pptx", formData, {
                headers: {
    ...
    const handleDownload = async () => {
        axios({
          url: `http://localhost:8000/api/convert/download/${selectedFile.name}/.pptx`,
          method: 'GET',
          ...
          .then((response) => {
            ...
            const convertedPDFPath = newName + '.pptx';
            ...
            axios.delete(`http://localhost:8000/api/convert/delete/${selectedFile.name}/.pptx`)
            .then((response) => {
    ...
    return (
        ...
        <div className="upload-right">
            ...
            <div className="compress">
                ...
                <button onClick={handlePPT}>Convert To PPTX</button>
                )}
            </div>
            </div>
